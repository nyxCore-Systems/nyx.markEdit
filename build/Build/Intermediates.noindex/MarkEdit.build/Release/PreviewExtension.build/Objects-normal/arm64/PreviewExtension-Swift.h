...
#ifndef PREVIEWEXTENSION_SWIFT_H
#define PREVIEWEXTENSION_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PreviewExtension",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSBundle;
@class NSCoder;
SWIFT_CLASS("_TtC16PreviewExtension21PreviewViewController")
...
- (void)viewDidLoad;
- (void)viewDidLayout;
- (void)preparePreviewOfFileAtURL:(NSURL * _Nonnull)url completionHandler:(void (^ _Nonnull)(NSError * _Nullable))completionHandler;
