...
#ifndef FINDEREXTENSION_SWIFT_H
#define FINDEREXTENSION_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FinderExtension",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSImage;
@class NSMenu;
SWIFT_CLASS("_TtC15FinderExtension11FinderTools")
@interface FinderTools : FIFinderSync
...
- (NSMenu * _Nonnull)menuForMenuKind:(FIMenuKind)menuKind SWIFT_WARN_UNUSED_RESULT;
@end
