...
#ifndef RENDERER_SWIFT_H
#define RENDERER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Renderer",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8Renderer24RendererWindowController")
@interface RendererWindowController : NSWindowController
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder SWIFT_UNAVAILABLE;
- (nonnull instancetype)initWithWindow:(NSWindow * _Nullable)window SWIFT_UNAVAILABLE;
@end

@class NSNotification;
@interface RendererWindowController (SWIFT_EXTENSION(Renderer)) <NSWindowDelegate>
- (void)windowWillClose:(NSNotification * _Nonnull)notification;
@end

@class NSToolbar;
@class NSToolbarItem;
@interface RendererWindowController (SWIFT_EXTENSION(Renderer)) <NSToolbarDelegate>
