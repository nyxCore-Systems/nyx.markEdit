...
#ifndef SETTINGSUI_SWIFT_H
#define SETTINGSUI_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SettingsUI",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10SettingsUI26SettingsRootViewController")
@interface SettingsRootViewController : NSTabViewController
- (void)viewDidLoad;
- (void)viewDidAppear;
...
@class NSTabView;
@class NSTabViewItem;
@interface SettingsRootViewController (SWIFT_EXTENSION(SettingsUI))
...
SWIFT_CLASS("_TtC10SettingsUI25SettingsTabViewController")
@interface SettingsTabViewController : NSViewController
