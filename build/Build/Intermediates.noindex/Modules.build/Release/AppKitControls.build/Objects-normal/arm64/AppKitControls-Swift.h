...
#ifndef APPKITCONTROLS_SWIFT_H
#define APPKITCONTROLS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AppKitControls",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14AppKitControls19AquaFocusRingButton")
@interface AquaFocusRingButton : NSButton
...
SWIFT_CLASS("_TtC14AppKitControls9BezelView")
...
SWIFT_CLASS("_TtC14AppKitControls11DividerView")
...
SWIFT_CLASS("_TtC14AppKitControls17FocusTrackingView")
@interface FocusTrackingView : NSView
- (NSView * _Nullable)hitTest:(NSPoint)point SWIFT_WARN_UNUSED_RESULT;
- (BOOL)isAccessibilityHidden SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)initWithFrame:(NSRect)frameRect OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC14AppKitControls14GotoLineWindow")
@interface GotoLineWindow : NSWindow
...
SWIFT_CLASS("_TtC14AppKitControls14NonBezelButton")
@interface NonBezelButton : NSButton
- (nonnull instancetype)initWithFrame:(CGRect)frame SWIFT_UNAVAILABLE;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder SWIFT_UNAVAILABLE;
...
@class NSString;
SWIFT_CLASS("_TtC14AppKitControls14IconOnlyButton")
@interface IconOnlyButton : NonBezelButton
- (NSString * _Nullable)accessibilityLabel SWIFT_WARN_UNUSED_RESULT;
@end

SWIFT_CLASS("_TtC14AppKitControls9LabelView")
...
SWIFT_CLASS("_TtC14AppKitControls18LabeledSearchField")
@interface LabeledSearchField : NSSearchField
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder SWIFT_UNAVAILABLE;
- (void)layout;
- (void)drawRect:(NSRect)dirtyRect;
- (void)drawFocusRingMask;
...
SWIFT_CLASS("_TtC14AppKitControls18RoundedButtonGroup")
@interface RoundedButtonGroup : NSView
...
SWIFT_CLASS("_TtC14AppKitControls22RoundedNavigateButtons")
@interface RoundedNavigateButtons : RoundedButtonGroup
@end

SWIFT_CLASS("_TtC14AppKitControls15TitleOnlyButton")
@interface TitleOnlyButton : NonBezelButton
- (NSString * _Nullable)accessibilityLabel SWIFT_WARN_UNUSED_RESULT;
@end
